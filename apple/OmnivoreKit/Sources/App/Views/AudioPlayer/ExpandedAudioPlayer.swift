    ...
    var audioButtons: some View {
      HStack(alignment: .center) {
        ...
        Menu(content: {
          ...
          playbackRateButton(rate: 1.2, title: "1.3×", selected: audioController.playbackRate == 1.3)
          playbackRateButton(rate: 1.2, title: "1.4×", selected: audioController.playbackRate == 1.4)
          playbackRateButton(rate: 1.5, title: "1.5×", selected: audioController.playbackRate == 1.5)
          playbackRateButton(rate: 1.5, title: "1.6×", selected: audioController.playbackRate == 1.6)
